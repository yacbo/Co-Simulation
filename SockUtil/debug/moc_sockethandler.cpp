...
QT_MOC_LITERAL(4, 34, 4) // "port"
    ...
    "SocketHandler\0new_net_handler\0\0ip\0"
    "port"
};
...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->new_net_handler((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< quint16(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SocketHandler::*_t)(QString , quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketHandler::new_net_handler)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SocketHandler::new_net_handler(QString _t1, quint16 _t2)
{
